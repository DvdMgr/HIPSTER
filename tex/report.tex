...
Is this really needed? A new protocol for file transfer - over UDP - with a bad channel in the middle. Such fun! \\
...
\begin{figure}[htp]
  \centering
  \includegraphics[width = 0.9\linewidth, keepaspectratio]{images/packet_structure.pdf}
...
\begin{figure}[htp]
  \centering
  \subfigure[Dropping probability]{\includegraphics[width=0.45\linewidth, keepaspectratio]{images/pDrop.pdf}}
  \subfigure[Mean delay]{\includegraphics[width=0.45\linewidth, keepaspectratio]{images/delayChannel.pdf}}
  \caption{TC statistics}
  \label{fig:TCstats}
\end{figure}
\begin{figure}[htp]
  \centering
  \includegraphics[width = 0.45\linewidth, keepaspectratio]{images/cdfChannel.pdf}
