...
\begin{figure}[htp]
  \centering
  \includegraphics[width=0.7\columnwidth, keepaspectratio]{Documentation/Sender.pdf}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=0.95\columnwidth, keepaspectratio]{Documentation/receiver_flowchart.pdf}
