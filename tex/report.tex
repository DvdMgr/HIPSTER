...
The transfer rate for files with different sizes was analyzed. The following
table summarizes the mean over five runs for the transfer time and speed for
\texttt{localhost}. A Local Area Network yield similar results.
\begin{table}[H]
\centering
\begin{tabular}{|c|c|c|}
	Size (MB) & Time (s) & Speed (MB/s)\\ \hline
	100       & 18.87    & 5.3  \\
	50        & 10.08    & 4.96 \\
	10        & 3.25     & 3.08 \\
	5         & 2.08     & 2.4  \\
