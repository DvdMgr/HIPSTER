...
\section{Concusion}
The HIPSTER protocol was designed in order to work upon networks with high rtt and high packet loss. The theoretical analysis provided some tuning for its parameters, and tests with files of different sizes showed that the protocol can reach high goodput and low transfer time.
O RLY? YUP!
\end{document}
